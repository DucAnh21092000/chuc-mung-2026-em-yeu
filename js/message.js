const listMessage = [
    {
        ...
        message: `Tôi với eiu của tôi hiện tại chưa có ảnh chụp chung nhưng chúng tôi có video quay chung với nhau
                        nè.`,
    ...
    },
    {
        ...
        message: `Em iu khen video này đẹp, và tôi cũng thấy như vậy. Video này tôi cũng hơi thuộc bài nên có chút tự tin`,
        comment: "Tôi bị ngại nhưng mà vì em iu thích nên tôi đã cố bước ra khỏi sự nhút nhát, ngại ngùng này",
        video: './video/quaytiktok.mp4'
    }
    , {
        title: "Video tặng quà Valentine cho eiu",
...
const finalMessage = [
    {
        ...
        comment: `Anh hi vọng rằng người bên cạnh em trong 2026 và những năm tới vẫn luôn là anh. Yêu thương, quan tâm nhau nhiều hơn nhó. Chúng ta cùng thực hiện những điều đối phương mong muốn và tránh xa/ hạn chế những thứ làm ảnh hưởng tới cảm xúc của nhau nhé. Và đây là món quà anh tặng em. https://lixi.momo.vn/lixi/bBRQj9pZv44K5PL`,
